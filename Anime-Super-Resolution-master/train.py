...
class SuperResolution(object):
    ...
    def __init__(self, scale=4, num_res_blocks=32,num_filters=64 ,pretrained_weights=None, name=None):
        self.scale = scale
        ...
        self.default_weights_save_path = 'weights2/weights_5_32_64/wdsr-b-' + \
